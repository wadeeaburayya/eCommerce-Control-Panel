...
<body style="background-color: #c5c5c5">
    ...
    <div class="login12">
        ...
        <table id="db">
            ...
            $records = mysqli_query($con,"select * from productcategory"); // fetch data from database
            ...
            while($row = mysqli_fetch_array($records))
            {
                ...
                echo " <tr>
                    ...
                    <td><a href='editcat.php?productCategoryID=".$row['productCategoryID']."' alt='edit'><i style='cursor: pointer; font-size:36px; color: black;' class='fas fa-edit' ></i></a></td>
                    </tr> ";
                    }
                        ?>
        </table>
