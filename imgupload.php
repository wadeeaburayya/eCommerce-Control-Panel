...
<?php
  ...
  if (isset($_POST['upload'])) {
    ...
    $tempname = $_FILES["uploadfile"]["tmp_name"];    
        ...
        $sql = "INSERT INTO product (productCategoryID, productName, productPrice, productImage) VALUES ('$productCategoryID', '$productName', '$productPrice', '$folder')";
  ...
  <label>Product Name</label>
                ...
                <option disabled selected>-- Select Category --</option>
                    <?php
                     ...
                     $records = mysqli_query($con, "SELECT productCategoryID, categoryName From productcategory");  // Use select query here 

                         while($data = mysqli_fetch_array($records))
                         {
                             echo "<option value='". $data['productCategoryID'] ."'>" .$data['categoryName'] ."</option>";  // displaying data in option menu
                        }	
                        ?>  
                 </select>
